...
export const aMiracleMileVersion2PassageSet: ExamPassageSet = {
  ...
  passage: createProsePassage({
    ...
    text: aMiracleMileVersion2PassageText,
    versionLabel: "2025-2026 Form B",
  }),
  questions: aMiracleMileVersion2Questions,
};
